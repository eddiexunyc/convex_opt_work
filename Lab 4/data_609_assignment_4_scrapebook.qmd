...
# define optimization variable λ (rates for each hour)
...
# Plot the λ values (estimated crash rates)
...
# solve the proble for every range of P
rho_values = [0.1, 1, 10]
lambda_values = []
