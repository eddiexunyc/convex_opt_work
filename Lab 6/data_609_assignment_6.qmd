...
# Make sure team_data_test.csv is in your working directory
...
team1_indices = test_data[:, 0].astype(int)  # First team (winner if label = 1)
team2_indices = test_data[:, 1].astype(int)  # Second team
actual_outcomes = test_data[:, 2]            # +1 if team1 won, -1 otherwise

# --- Predict outcomes based on ahat ---
# (You should already have "ahat" from part (b))
